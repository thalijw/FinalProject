...
if(isset($_POST['text'])){
	...
	if ($result->num_rows)
		...
		queryMysqli("INSERT INTO profiles VALUES('$user' , '$text')");
} else{
	if($result->num_rows){
...
if (isset($_FILES['image']['name'])){
	...
	switch($_FILES['image']['type']){
		...
		case "image/jpeg" : // Both reqular and progressive jpegs
...
?>
	image: <input type = 'file' name = 'image' size = '14' id='But1'>
	<input type = 'submit' value = 'Save Profile' id='But1'>
	</form></div><br>
</body>
</html>
